...
public class Game_4 extends AppCompatActivity {
    ...
    private void initData() {
        ...
        rectangle[2] = (new Rectangle(R.id.y2, 0, 1, 2));
        rectangle[3] = (new Rectangle(R.id.y3, 3, 4, 2));
        rectangle[4] = (new Rectangle(R.id.y4, 3, 1, 2));
        rectangle[5] = (new Rectangle(R.id.x1, 1, 1, 3));
        rectangle[6] = (new Rectangle(R.id.z1, 0, 2, 4));
        rectangle[7] = (new Rectangle(R.id.z2, 1, 2, 4));
        rectangle[8] = (new Rectangle(R.id.z3, 2, 2, 4));
        rectangle[9] = (new Rectangle(R.id.z4, 3, 2, 4));
        for (int i = 0; i <= 9; i++) {
