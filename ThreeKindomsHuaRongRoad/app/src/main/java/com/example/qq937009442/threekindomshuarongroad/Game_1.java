...
//    private final String G_STEP=
//            "com.example.qq937009442.threekindomshuarongroad.game_1.numstep";
//    private final String G_GAMELOC=
//            "com.example.qq937009442.threekindomshuarongroad.game_1.gameloc";
//    private final String G_TIME=
//            "com.example.qq937009442.threekindomshuarongroad.game_1.time";
    ...
    private void initData() {
        ...
        rectangle[1] = (new Rectangle(R.id.y1, 0, 4, 2));
        rectangle[2] = (new Rectangle(R.id.y2, 0, 2, 2));
        rectangle[3] = (new Rectangle(R.id.y3, 3, 4, 2));
        rectangle[4] = (new Rectangle(R.id.y4, 3, 2, 2));
        rectangle[5] = (new Rectangle(R.id.x1, 1, 2, 3));
        rectangle[6] = (new Rectangle(R.id.z1, 0, 0, 4));
        rectangle[7] = (new Rectangle(R.id.z2, 1, 1, 4));
        rectangle[8] = (new Rectangle(R.id.z3, 2, 1, 4));
